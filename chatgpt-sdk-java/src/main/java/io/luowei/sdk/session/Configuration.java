...
import io.luowei.sdk.IOpenAiApi;
import io.luowei.sdk.executor.Executor;
import io.luowei.sdk.executor.aigc.GLMExecutor;
import io.luowei.sdk.executor.aigc.GLMOldExecutor;
...
public class Configuration {
    ...
    // http keywords
    public static final String SSE_CONTENT_TYPE = "text/event-stream"; // sse请求
